...
public final class HeroData {
    ...
    public static final UnitCard GAN_NING = new UnitCard("甘宁", CardConstants.UnitType.GUNNER, 5, 3, 8);
    public static final UnitCard TAI_SHI_CI = new UnitCard("太史慈", CardConstants.UnitType.CAVALRY, 5, 4, 8);
    public static final UnitCard SUN_CE = new UnitCard("孙策", CardConstants.UnitType.CAVALRY, 5, 4, 9);
    ...
    public static final UnitCard XU_CHU = new UnitCard("许褚", CardConstants.UnitType.ARMOR, 5, 2, 9);
    public static final UnitCard XIA_HOU_YUAN = new UnitCard("夏侯渊", CardConstants.UnitType.SHOOTER, 4, 2, 6);
